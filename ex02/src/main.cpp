...
/*   Updated: 2024/11/22 16:21:34 by gstronge         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	std::cout << "\033[34;1m--creating FragTrap object no_name--\n\033[0m";
	FragTrap	no_name;
	
	std::cout << "\n" << "\033[33;1m--creating FragTrap object bob--\n\033[0m";
	FragTrap	bob("bob");
	...
	std::cout << "\n" << "\033[35;1m--creating FragTrap object terry (a copy of bob)--\n\033[0m";
	FragTrap	terry(bob);

	std::cout << "\n" << "\033[35;1m--calling terry.highFivesGuys();--\n\033[0m";
	terry.highFivesGuys();

	std::cout << "\n" << "\033[35;1m--creating FragTrap object jane (a copy assignment of bob)--\n\033[0m";
	FragTrap	jane;
	jane = bob;
